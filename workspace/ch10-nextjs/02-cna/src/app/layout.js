          ...
          <div class="flex flex-col min-h-screen dark:bg-gray-700 dark:text-gray-200 transition-color duration-500 ease-in-out">
              ...
              <nav class="flex flex-wrap justify-center items-center p-4 md:flex-nowrap md:justify-between">
                ...
                <div class="w-auto order-2 text-base mt-4 md:mt-0">
                  <ul class="flex items-center gap-6 uppercase">
                    <li class="hover:text-amber-500 hover:font-semibold">
                      <a href="/info">정보공유</a>
                    </li>
                    <li class="hover:text-amber-500 hover:font-semibold">
                      <a href="/free">자유게시판</a>
                    </li>
                    <li class="hover:text-amber-500 a:font-semibold">
                      <a href="/qna">질문게시판</a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="w-1/2 order-1 flex justify-end items-center md:order-2 md:w-auto">
                  <div class="flex justify-end">
                    <a
                      href="/user/login"
                      class="bg-orange-500 py-1 px-2 text-sm text-white font-semibold ml-2 hover:bg-amber-400 rounded"
                    >
                      로그인
                    </a>
                    <a
                      href="/user/signup"
                      class="bg-gray-900 py-1 px-2 text-sm text-white font-semibold ml-2 hover:bg-amber-400 rounded"
                    >
                      회원가입
                    </a>
                  </div>
            ...
            <footer class="p-4 pb-12 w-full border-t border-t-slate-200  dark:border-t-slate-500 dark:bg-gray-600 text-gray-600 dark:text-white transition-color duration-500 ease-in-out">
              <div class="min-w-[320px] flex flex-wrap gap-4 justify-center items-center text-sm text-slate-400">
                <a
                  href="#"
                  class="hover:font-semibold dark:hover:text-gray-200"
                >
                  약관
                </a>
                <a
