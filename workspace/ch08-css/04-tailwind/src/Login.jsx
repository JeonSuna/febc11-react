      ...
      <form className="flex flex-col">
        <div className="mb-4 text-left">
          ...
          <input
            type="email"
            id="email"
            className="w-full p-2 rounded-[4px] border border-gray-300 text-red-500 bg-blue-500"
            required
          />
        </div>
        <div className="mb-4 text-left">
          ...
          <input
            type="password"
            id="password"
            className="w-full p-2 rounded-[4px] border border-gray-300 text-blue-500 bg-red-500"
            required
          />
        </div>
